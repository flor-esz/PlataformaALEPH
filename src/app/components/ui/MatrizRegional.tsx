...
// ─── Main component ───────────────────────────────────────────────────────────
export function MatrizRegional({ clasificacion }: MatrizRegionalProps) {
  return (
                  ...
                  return (
                    <td key={col} className="px-4 py-3">
                      <span
                        ...
                        style={{ backgroundColor: FILA_BG[fila], color: "white", fontFamily: "Space Grotesk, sans-serif", width: 44, height: 28 }}
                      >
