...
function ImpactoEconomico({ country = "Todos", onCountryChange, onNavigate }: {
  ...
  const estrategicoData: ReporteEstrategicoData = {
    ...
    graficas: [
      ...(FEATURES.costoEstimadoPorDimension ? [{
      ...
      ...(FEATURES.afectacionMipymeImpacto ? [{
  ...
  return (
    <div className="p-4 md:p-8 overflow-y-auto h-full">
      <Header
        ...
        actions={
          <>
            ...
            {FEATURES.descargaImpactoEconomico && (
              <DescargarDropdown
                hojas={[hojaResumen, FEATURES.costoEstimadoPorDimension && hojaCostoPorPais, hojaCanalesTramites, hojaCanalesBarreras, FEATURES.afectacionMipymeImpacto && hojaMipyme, hojaCostoPorTramite].filter(Boolean)}
                filtrosActivos={[{ label: "País", value: country === "Todos" ? "Todos los países" : country }]}
      ...
      {FEATURES.metodologiaCostosSupuestos && (
